...
const VistaHomeIndicadores = ({navigation}: any) => {
    return (
        <ScrollView>
            <VStack alignItems="center" paddingBottom={10}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
                    <Pressable 
                        // Redirigir a vista Abonos y Retiros
                        onPress={() => navigation.navigate("Tipo Indicador Fecha")}
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
                    <Pressable 
                        // Redirigir a vista Abonos y Retiros
                        onPress={() => navigation.navigate("Tipo Indicador Año")}
                        style={{ width: 300, height: 220 }}
                    >
                        <Image 
                            source={require('../../../assets/images/VolumenMercado.png')}
...
export default VistaHomeIndicadores;